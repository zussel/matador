...
public:
  ...
  virtual void write_value(size_t pos, const short &x) = 0;
  virtual void write_value(size_t pos, const int &x) = 0;
  virtual void write_value(size_t pos, const long &x) = 0;
  virtual void write_value(size_t pos, const long long &x) = 0;
  virtual void write_value(size_t pos, const unsigned char &x) = 0;
  virtual void write_value(size_t pos, const unsigned short &x) = 0;
  virtual void write_value(size_t pos, const unsigned int &x) = 0;
  virtual void write_value(size_t pos, const unsigned long &x) = 0;
  virtual void write_value(size_t pos, const unsigned long long &x) = 0;
