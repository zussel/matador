...
class query_create_table_intermediate : public intermediate {
public:
  using intermediate::intermediate;

  query_create_table_columns_intermediate columns(std::initializer_list<column> cols);
  query_create_table_columns_intermediate columns(const std::list<column> &cols);
  query_create_table_columns_intermediate columns(const std::vector<column> &cols);
};
...
class query_create_intermediate : public intermediate {
public:
