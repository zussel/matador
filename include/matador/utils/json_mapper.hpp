...
template < class T >
class json_mapper : public generic_json_parser_ng<json_mapper<T>>
{
public:
  json_mapper() : generic_json_parser_ng<json_mapper<T>>(this) {}
  ...
  void on_number(typename generic_json_parser_ng<json_mapper<T>>::number_t value);
...
template<class T>
T* json_mapper<T>::from_string(const char *str)
{
...
template<class T>
void json_mapper<T>::on_number(typename generic_json_parser_ng<json_mapper<T>>::number_t value)
{
  if (value.is_real) {
