...
ConvertTestUnit::convert_to_long()
{
  ...
  CONVERT_NUMERIC_EXPECT_SUCCESS_WEAK          (unsigned int, long, min, convert_weak);
  CONVERT_NUMERIC_EXPECT_SUCCESS_WEAK          (unsigned int, long, max, convert_weak);
  CONVERT_NUMERIC_EXPECT_SUCCESS_RESULT        (unsigned int, long, min,  0, convert_weak);
  CONVERT_NUMERIC_EXPECT_SUCCESS_RESULT        (unsigned int, long, max, -1, convert_weak);
  ...
  CONVERT_NUMERIC_EXPECT_SUCCESS_RESULT        (float, long, max, 0x80000000, convert_weak);
...
ConvertTestUnit::convert_to_unsigned_char()
{
  ...
  CONVERT_NUMERIC_EXPECT_SUCCESS_WEAK          (char, unsigned char, max, convert_weak);
  CONVERT_NUMERIC_EXPECT_SUCCESS_RESULT        (char, unsigned char, min, 0, convert_weak);
  CONVERT_NUMERIC_EXPECT_SUCCESS_RESULT        (char, unsigned char, max, 0, convert_weak);
  ...
  CONVERT_NUMERIC_EXPECT_SUCCESS_RESULT        (long, unsigned char, min,  0, convert_weak);
  CONVERT_NUMERIC_EXPECT_SUCCESS_RESULT        (long, unsigned char, max, -1, convert_weak);
...
ConvertTestUnit::convert_to_unsigned_short()
{
  ...
  CONVERT_NUMERIC_EXPECT_SUCCESS               (char, unsigned short, min, convert_weak);
  ...
  CONVERT_NUMERIC_EXPECT_FAILURE               (short, unsigned short, max, convert_fitting);
  CONVERT_NUMERIC_EXPECT_SUCCESS_WEAK          (short, unsigned short, min, convert_weak);
  CONVERT_NUMERIC_EXPECT_SUCCESS_WEAK          (short, unsigned short, max, convert_weak);
  CONVERT_NUMERIC_EXPECT_SUCCESS_RESULT        (short, unsigned short, min,  0, convert_weak);
  CONVERT_NUMERIC_EXPECT_SUCCESS_RESULT        (short, unsigned short, max, -1, convert_weak);
  ...
  CONVERT_NUMERIC_EXPECT_SUCCESS               (unsigned char, unsigned short, min, convert_strict);
  CONVERT_NUMERIC_EXPECT_SUCCESS               (unsigned char, unsigned short, max, convert_strict);
...
ConvertTestUnit::convert_to_unsigned_int()
{
  ...
  CONVERT_NUMERIC_EXPECT_SUCCESS               (char, unsigned int, min, convert_weak);
  ...
  CONVERT_NUMERIC_EXPECT_SUCCESS               (short, unsigned int, min, convert_fitting);
  CONVERT_NUMERIC_EXPECT_SUCCESS               (short, unsigned int, max, convert_fitting);
  CONVERT_NUMERIC_EXPECT_SUCCESS               (short, unsigned int, min, convert_weak);
  ...
  CONVERT_NUMERIC_EXPECT_FAILURE               (int, unsigned int, max, convert_fitting);
  CONVERT_NUMERIC_EXPECT_SUCCESS_WEAK          (int, unsigned int, min, convert_weak);
  CONVERT_NUMERIC_EXPECT_SUCCESS_WEAK          (int, unsigned int, max, convert_weak);
  CONVERT_NUMERIC_EXPECT_SUCCESS_RESULT        (int, unsigned int, min,  0, convert_weak);
  CONVERT_NUMERIC_EXPECT_SUCCESS_RESULT        (int, unsigned int, max, -1, convert_weak);
  ...
  CONVERT_NUMERIC_EXPECT_SUCCESS_RESULT        (long, unsigned int, min,  0, convert_weak);
  ...
  CONVERT_NUMERIC_EXPECT_SUCCESS               (unsigned char, unsigned int, min, convert_strict);
  CONVERT_NUMERIC_EXPECT_SUCCESS               (unsigned char, unsigned int, max, convert_strict);
  ...
  CONVERT_NUMERIC_EXPECT_SUCCESS               (unsigned short, unsigned int, min, convert_strict);
  CONVERT_NUMERIC_EXPECT_SUCCESS               (unsigned short, unsigned int, max, convert_strict);
  ...
  CONVERT_NUMERIC_EXPECT_SUCCESS_WEAK          (float, unsigned int, max, convert_weak);
...
ConvertTestUnit::convert_to_unsigned_long()
{
  ...
  CONVERT_NUMERIC_EXPECT_SUCCESS               (short, unsigned long, min, convert_fitting);
  CONVERT_NUMERIC_EXPECT_SUCCESS               (short, unsigned long, max, convert_fitting);
  CONVERT_NUMERIC_EXPECT_SUCCESS_RESULT        (short, unsigned long, min, 0, convert_weak);
  ...
  CONVERT_NUMERIC_EXPECT_FAILURE               (int, unsigned long, max, convert_fitting);
  CONVERT_NUMERIC_EXPECT_SUCCESS_RESULT        (int, unsigned long, min,  0, convert_weak);
  ...
  CONVERT_NUMERIC_EXPECT_FAILURE               (long, unsigned long, max, convert_fitting);
  ...
  CONVERT_NUMERIC_EXPECT_SUCCESS_WEAK          (float, unsigned long, min, convert_weak);
  CONVERT_NUMERIC_EXPECT_SUCCESS_WEAK          (float, unsigned long, max, convert_weak);
  ...
  CONVERT_NUMERIC_EXPECT_SUCCESS_WEAK          (double, unsigned long, min, convert_weak);
  CONVERT_NUMERIC_EXPECT_SUCCESS_WEAK          (double, unsigned long, max, convert_weak);
