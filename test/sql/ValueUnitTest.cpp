...
void ValueUnitTest::test_serialize()
{
  ...
  UNIT_ASSERT_EQUAL(17UL, vlist->values_.size());
  ...
  UNIT_ASSERT_EQUAL("'H'", vlist->values_[7]->str());
  UNIT_ASSERT_EQUAL("128", vlist->values_[8]->str());
  UNIT_ASSERT_EQUAL("65000", vlist->values_[9]->str());
  UNIT_ASSERT_EQUAL("128000", vlist->values_[10]->str());
  UNIT_ASSERT_EQUAL("1", vlist->values_[11]->str());
  UNIT_ASSERT_EQUAL("'Hallo'", vlist->values_[12]->str());
  UNIT_ASSERT_EQUAL("'Welt'", vlist->values_[13]->str());
  UNIT_ASSERT_EQUAL("'Erde'", vlist->values_[14]->str());
}
