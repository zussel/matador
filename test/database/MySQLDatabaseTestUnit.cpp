  ...
  : unit_test("database test unit")
{
  ...
  add_test("vector", std::tr1::bind(&MySQLDatabaseTestUnit::with_vector, this), "object with object vector database test");
  add_test("reload", std::tr1::bind(&MySQLDatabaseTestUnit::reload, this), "reload database test");
  add_test("list2", std::tr1::bind(&MySQLDatabaseTestUnit::with_list2, this), "object with object list database test");
  add_test("reload_container", std::tr1::bind(&MySQLDatabaseTestUnit::reload_container, this), "reload object list database test");
}
...
void
MySQLDatabaseTestUnit::initialize()
{
...
void
MySQLDatabaseTestUnit::finalize()
{
  ostore_.clear(true);
}
...
void
MySQLDatabaseTestUnit::with_list()
{
...
void
MySQLDatabaseTestUnit::with_list2()
{
...
void
MySQLDatabaseTestUnit::with_vector()
{
}

void
MySQLDatabaseTestUnit::reload()
{
  typedef ObjectItem<Item> object_item_t;
  typedef object_ptr<object_item_t> object_item_ptr;
  typedef object_ptr<Item> item_ptr;
...
void
MySQLDatabaseTestUnit::reload_container()
{
