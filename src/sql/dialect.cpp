...
query_context dialect::compile(const query_compile_context& data, const std::optional<std::reference_wrapper<const connection_impl>> conn) const
{
    return compiler_->compile(data, *this, conn);
}
