...
void any_type_to_string_visitor::to_string(float &val)
{
  utils::convert(result, val);
}

void any_type_to_string_visitor::to_string(double &val)
{
  utils::convert(result, val);
}
...
void any_type_to_string_visitor::to_string(time &val)
{
  result = "'" + d.prepare_literal(utils::to_string(val, "%FT%T.%f")) + "'";
}

void any_type_to_string_visitor::to_string(date &val)
{
