...
identifier::null_pk::null_pk()
  : base(std::type_index(typeid(utils::null_type_t)), detail::identifier_type_traits<utils::null_type_t>::type(), data_type::type_null)
{}
...
{
  return detail::identifier_type_traits<utils::null_type_t>::is_valid();
}

std::string identifier::null_pk::str() const
{
  return detail::identifier_type_traits<utils::null_type_t>::to_string();
}
