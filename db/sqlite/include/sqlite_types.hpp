...
template <> struct type_traits<oos::date> { inline static const char* type_string() { return "INTEGER"; } };
template <> struct type_traits<oos::time> { inline static const char* type_string() { return "TEXT"; } };
